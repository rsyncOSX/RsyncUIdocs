...
[Released](https://github.com/RsyncUI/RsyncUI/releases/tag/v6.5.6) 18 January 2021
...
I am focusing on developing a SwiftUI based version of RsyncUI and version 6.5.6 will probably be the last release for some time. Reported issues will be fixed (if bugs). There will most likely not be any further enhancements before the SwiftUI based version is released sometime in 2021.
