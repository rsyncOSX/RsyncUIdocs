...
## Next version (sometime in December 2023) - 11 Nov 2023
...
There will be a version to try out what `NavigationStack` is before release in a week or two before release of new version. Personally I believe this is more convenient to use, but most likely next release will enable the user to choose what to use by settings.
