...
## Minor issue in version 1.2.1

There is a minor issue in refreshing the view for deleting logrecords. The view is not updated after delete. Workaround is change to another view and return.

The issue is fixed and there will be a new release shortly. 
