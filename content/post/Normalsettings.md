...
The new confirm dialog if number of files to synchronize is like a new task:
...
```
The local attached volume is not connected, the estimate may think there is a new synchronize task. If you just forgot to attach the disk you dont want RsyncUI to synchronize data to the `/Volume` catalog. 
